# HoloClaw ML Trading Architecture v6

**Status:** YAML-Configured Strategies & OpenClaw Scanner Integration (2026-03-12)  
...
**Interface:** Modular Python architecture with ML-first design
...
- **OpenClaw Scanner Integration** — Real-time market scanning via OpenClaw agent tools, Discord/Telegram alerts
- **ML-First Architecture** — Feature-rich engineering, ensemble models, regime detection
...
- **Advanced Scanner Engine** — Technical indicators, candlestick patterns, ML-based signals
- **Modular Strategy Design** — Dynamic strategy loading, per-symbol filtering, ensemble voting
